...
class Spiral {
  ...
  draw(time, index) {
    ...
    for (
      ...
      const x = 0//sin(time*2)
      const y = map(shadowIndex, 0, shadowsCount, -2.5, 2.5);
      // const y = sin(time) * cos(time*2) * 2
      ...
      for (let angle = 0; angle < TAU; angle += angleStep) {
        ...
        rotate(angle*2+radians(angle*40)+time);
