...
//       );
      ...
      let angle = map(lerpIndex, 0, 1.5, map(sin(time/2), -1, 1, -TAU, TAU), -map(cos(time/2), -1, 1, -TAU, TAU));
...
//       angle = lerpIndex*12;
      ...
      target.circle(lerpPosition.x + xOffset, lerpPosition.y + yOffset, 100/1.2);
      target.circle(lerpPosition.x - xOffset, lerpPosition.y - yOffset, 100/1.2);
    }
