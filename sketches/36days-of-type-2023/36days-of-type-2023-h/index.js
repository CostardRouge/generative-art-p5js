...
sketch.draw( (time, center) => {
  ...
  for (let z = 0; z < depthSteps; z++) {
    ...
    const pointsSet1 = mappers.circularIndex(s+z/depthSteps, [
      currentLetterPoints,
      nextLetterPoints,
      currentLetterPoints,
      nextLetterPoints,
    ...
    const pointsSet2 = mappers.circularIndex(1+s+z/depthSteps, [
      currentLetterPoints, nextLetterPoints
    ])

    const points = lerpPoints(pointsSet1, pointsSet1, p )
