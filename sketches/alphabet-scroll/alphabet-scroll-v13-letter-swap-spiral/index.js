...
sketch.draw( (time, center) => {
  ...
  drawCircle({
    ...
    render: ( angle, progression, endPosition, middlePosition ) => {
      ...
      // const pointsProgression = mappers.fn(cos(polarProgression), -1, 1, 0, alphabet.length-1, easing.easeInOutExpo);
      ...
      for (let i = 0; i < points.length; i++) {
        ...
        const opacityFactor = mappers.fn(sin(-time*2+angle+progression), -1, 1, 50, 1, easing.easeInOutExpo);
