...
sketch.draw( ( time, center, favoriteColor ) => {
  ...
  // })
    ...
    for (let b = 0; b < branchCount; b++) {
      ...
      const wavesStrength = mappers.fn(circularStepsProgression, 0, 1, 0, 1, easing.easeInOutSine)
      const wavesCount = mappers.fn(circularStepsProgression, 1, 0, 0, 2, easing.easeInOutSine);
      ...
      const a = 200//map(sin(time+b), -1, 1, margin, -margin)
      ...
      const linesCount = 4//mappers.fn(circularStepsProgression, 0, 1, 1, 4, easing.easeInOutQuad)
      ...
      for (let lineIndex = lineMin; lineIndex < lineMax; lineIndex += lineStep) {
        const vector = converters.polar.vector(
          ...
          // mappers.fn(circularStepsProgression, 0, 1, 10, 30, easing.easeInOutExpo)
        ...
        beginShape();
        strokeWeight(mappers.fn(circularStepsProgression, 0, 1, 10, 20, easing.easeInOutExpo));
        // strokeWeight(20);
        ...
        const offset = animation.ease({
          values: [0.3, 0],
          duration: 1,
          easingFn: easing.easeInOutCubic,
          currentTime: time/2+b
        });
        ...
        stroke(
          colors.rainbow({
            ...
            // hueIndex: mappers.fn(sin(stepsProgression+noise(branchProgression+progression, circularStepsProgression/10)), -1, 1, -PI, PI, easing.easeInOutSine_)*8,
            hueIndex: mappers.fn((
              noise(branchProgression, stepsProgression+time/2)
